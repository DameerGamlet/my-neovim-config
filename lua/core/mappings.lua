...
M.general = {
  ...
  n = {
    ...
    ["<leader>Q"] = { "<cmd> qa <CR>", "Close" },
    ["<leader>qa"] = { "<cmd> qa <CR>", "Close" },
    ["<leader>qw"] = { "<cmd> wq <CR>", "Close" },
    ...
    -- Allow moving the cursor through wrapped line
...
M.telescope = {
  ...
  n = {
    ...
    ["<leader>tz"] = { "<cmd> Telescope current_buffer_fuzzy_find <CR>", "Find in current buffer" },
    ...
    ["<leader>tbm"] = { "<cmd> Telescope marks <CR>", "telescope bookmarks" },
  },
}
